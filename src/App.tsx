...
function IntroAnimation({ onComplete }: { onComplete: () => void }) {
  ...
  const arrowStyle = (dur: number): React.CSSProperties => ({
    ...
    transition: phase >= 1
      ? `clip-path ${dur}s cubic-bezier(0.25,0.1,0.25,1) 0ms`
      : "none",
  });

  const labels = [
    { text: "Higher",    pos: { left: "17.19%",  top: "18.32%" },                              delay: 0   },
    { text: "Standard",  pos: { left: "62.88%",  top: "18.32%" },                              delay: 100 },
    { text: "In hiring", pos: { left: "17.19%",  top: "84.87%" },                              delay: 200 },
    { text: "People",    pos: { right: "14.85%", top: "84.87%", textAlign: "right" as const }, delay: 300 },
  ];
...
function AboutSection() {
  ...
  // Desktop scatter positions (relative to the lines SVG container)
  const CARD_POSITIONS: Record<string, React.CSSProperties> = {
    exp:      { left: "0%",  top: "4%"  },
    coach:    { right: "0%", top: "16%" },
    consult:  { left: "0%",  top: "65%" },
    platform: { right: "0%", top: "68%" },
  };
  ...
  return (
    <section ref={sectionRef} id="about" className="bg-[#ffedd7] w-full py-[134px]">
      <div className="max-w-[1440px] mx-auto px-[16px] md:px-[30px]">
        ...
        {/* ── Desktop xl+: scatter layout ── */}
        <div className="hidden xl:block relative" style={{ minHeight: "760px" }}>

          {/* Lines SVG — centered, appears after phase B */}
          <div style={{
            position: "absolute",
            left: "50%", top: "50%",
            transform: "translate(-50%, -50%)",
            ...
            {/* Inline about-lines SVG paths so we can animate each one */}
            <svg viewBox="0 0 593.263 709.912" width="100%" style={{ display: "block" }} fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M298.484 107.376L296.651 110.551H300.317L298.484 107.376ZM298.484 695.591L300.317 692.416H296.651L298.484 695.591ZM298.484 110.233H298.167V692.734H298.484H298.802V110.233H298.484Z" fill="#4D453B" style={aStyle(0.55)}/>
              <path d="M379 126.591L376.164 128.913L379.593 130.208L379 126.591ZM298.187 339.65L298.075 339.947L298.669 340.171L298.781 339.874L298.484 339.762L298.187 339.65ZM377.99 129.264L377.693 129.152L298.187 339.65L298.484 339.762L298.781 339.874L378.287 129.376L377.99 129.264Z" fill="#4D453B" style={aStyle(0.85)}/>
              <path d="M441.143 193.738L437.539 195.75L440.762 197.488L441.143 193.738ZM298.196 339.527L298.055 339.813L298.614 340.109L298.756 339.822L298.484 339.681L298.196 339.527ZM439.898 196.235L439.61 196.08L298.196 339.527L298.484 339.681L298.756 339.822L440.186 196.389L439.898 196.235Z" fill="#4D453B" style={aStyle(1.0)}/>
              <path d="M242.188 107.376L239.875 110.202L243.484 110.695L242.188 107.376ZM298.457 339.756L298.379 340.065L298.995 340.22L299.073 339.911L298.765 339.834L298.457 339.756ZM243.031 109.993L242.723 109.915L298.457 339.756L298.765 339.834L299.073 339.911L299.339 110.07L243.031 109.993Z" fill="#4D453B" style={aStyle(0.72)}/>
              <path d="M156.416 289.651L159.856 291.098L159.702 287.485L156.416 289.651ZM298.779 339.554L298.939 339.272L298.378 338.951L298.217 339.233L298.484 339.393L298.779 339.554ZM158.726 289.059L158.465 289.219L298.484 339.393L298.779 339.554L299.04 339.714L158.988 288.899L158.726 289.059Z" fill="#4D453B" style={aStyle(1.45)}/>
              <path d="M66.0977 282.651L69.1826 284.731L69.7676 281.158L66.0977 282.651ZM298.722 339.6L298.856 339.314L298.278 339.044L298.143 339.33L298.412 339.462L298.722 339.6ZM68.4014 283.393L68.1328 283.525L298.412 339.462L298.722 339.6L299.006 339.738L68.6719 283.261L68.4014 283.393Z" fill="#4D453B" style={aStyle(1.8)}/>
              <path d="M66.0977 505.887L69.7676 507.38L69.1826 503.807L66.0977 505.887ZM298.412 339.075L298.143 339.207L298.278 339.493L298.856 339.223L298.722 338.937L298.412 339.075ZM68.1328 505.012L68.4014 505.144L298.722 338.937L298.412 339.075L298.143 339.207L67.8623 505.012H68.1328Z" fill="#4D453B" style={aStyle(2.0)}/>
              <path d="M535.483 107.376L533.17 110.202L536.779 110.695L535.483 107.376ZM298.457 339.756L298.223 340.065L298.839 340.22L299.073 339.911L298.765 339.834L298.457 339.756ZM534.326 109.993L534.018 109.915L298.457 339.756L298.765 339.834L299.073 339.911L535.341 110.07L534.326 109.993Z" fill="#4D453B" style={aStyle(0.65)}/>
              <path d="M593.263 0L590.073 2.13281L593.263 4.38281V0ZM298.484 339.393L298.221 339.634L298.484 339.876L298.748 339.634L298.484 339.393ZM591.162 2.62891L590.898 2.87109L298.748 339.634L298.484 339.876L298.221 340.118L591.426 2.87109L591.162 2.62891Z" fill="#4D453B" style={aStyle(2.1)}/>
              <path d="M156.416 498.887L159.702 501.053L159.856 497.44L156.416 498.887ZM298.217 339.394L298.378 339.111L298.217 339.07L298.484 339.231L298.779 339.392L298.779 339.392ZM158.465 499.318L158.726 499.478L298.484 339.231L298.217 339.07L297.95 339.231L158.204 499.158L158.465 499.318Z" fill="#4D453B" style={aStyle(1.35)}/>
              <path d="M441.143 494.8L440.762 491.05L437.539 492.788L441.143 494.8ZM298.756 338.919L298.614 338.631L298.055 338.927L298.196 339.213L298.484 339.069L298.756 338.919ZM439.61 492.658L439.898 492.503L298.484 339.069L298.196 339.213L297.908 339.357L439.322 492.813L439.61 492.658Z" fill="#4D453B" style={aStyle(1.6)}/>
              <path d="M535.483 0L533.17 2.82617L536.779 3.31934L535.483 0ZM298.457 339.393L298.457 339.756L298.765 339.834L299.073 339.393L298.765 338.952L298.457 339.393ZM534.326 2.61719L534.018 2.61719V339.393L298.457 339.393L298.765 339.393L535.341 2.61719H534.326Z" fill="#4D453B" style={aStyle(1.9)}/>
              <path d="M593.263 709.912L593.263 705.524L590.073 707.779L593.263 709.912ZM298.484 339.876L298.221 339.634L298.484 339.393L298.748 339.634L298.484 339.876ZM591.162 707.271L590.898 707.029L298.748 339.634L298.484 339.876L298.221 340.118L590.898 707.541L591.162 707.271Z" fill="#4D453B" style={aStyle(2.15)}/>
              <path d="M0 0L0 4.38281L3.19043 2.13281L0 0ZM298.484 339.393L298.748 339.634L298.484 339.876L298.221 339.634L298.484 339.393ZM1.91016 2.62891L2.17383 2.87109L298.221 339.634L298.484 339.876L298.748 340.118L2.4375 2.87109L1.91016 2.62891Z" fill="#4D453B" style={aStyle(2.2)}/>
              <path d="M0 709.912L3.19043 707.779L0 705.524V709.912ZM298.221 339.634L298.484 339.393L298.748 339.634L298.484 339.876L298.221 339.634ZM2.17383 707.541L1.91016 707.271L298.221 339.634L298.484 339.876L298.748 340.118L2.4375 707.541H2.17383Z" fill="#4D453B" style={aStyle(2.05)}/>
              <circle cx="298.484" cy="339.762" r="4.76201" fill="#FFEDD7" stroke="#4D453B" strokeWidth="0.634935"/>
            </svg>

            {/* Tiffany photo — centered on the SVG's center dot (50.27%, 47.82% of SVG) */}
            <div style={{
              position: "absolute",
              left: "50%", top: "47.82%",
              transform: "translate(-50%, -50%)",
            ...
            <p style={{
              ...STYLE_DISPLAY, fontSize: "clamp(18px, 2vw, 28px)", color: "black",
              position: "absolute", left: "5%", top: "44%",
              opacity: triggered ? 1 : 0, transition: "opacity 0.5s ease 200ms",
            }}>Tiffany</p>
            <p style={{
              ...STYLE_DISPLAY, fontSize: "clamp(18px, 2vw, 28px)", color: "black",
              position: "absolute", right: "5%", top: "44%", textAlign: "right",
              opacity: triggered ? 1 : 0, transition: "opacity 0.5s ease 200ms",
            }}>Philippou</p>
          </div>

          {/* Cards — appear at phase C */}
          {ABOUT_CARDS.map((card, i) => (
            <AboutCard
              key={card.id}
              card={card}
              style={CARD_POSITIONS[card.id]}
              visible={cardsPhase}
              delay={i * 150}
            />
          ))}
